...
`KILL_SWITCH=1` в v1.2.0 означает использование `hold/fail-closed` режима. Параметр сохранён для совместимости с существующими конфигурациями v1.1.0.
...
Скрипт не привязан к имени `wan`, `LTE`, `wwan0` и т.п. Он ждёт факт появления рабочего uplink.
